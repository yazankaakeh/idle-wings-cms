...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="content-info" role="tabpanel" aria-labelledby="content-info-tab">
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <select class="theme-input-style" id="blogPostStyle" name="post_style" required
                    onchange="selectPostStyleOption('most_viewed_blog')">
                    <option value="s_one" @selected(getHomePageSectionProperties($details->id, 'post_style') == 's_one')>{{ translate('Style 1') }}</option>
                    <option value="s_two" @selected(getHomePageSectionProperties($details->id, 'post_style') == 's_two')>{{ translate('Style 2') }}</option>
                    <option value="s_three" @selected(getHomePageSectionProperties($details->id, 'post_style') == 's_three')>{{ translate('Style 3') }}</option>
                    <option value="s_four" @selected(getHomePageSectionProperties($details->id, 'post_style') == 's_four')>{{ translate('Style 4') }}</option>
                    <option value="s_five" @selected(getHomePageSectionProperties($details->id, 'post_style') == 's_five')>{{ translate('Style 5') }}</option>
                </select>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="input-group">
                            <input type="radio" @checked(getHomePageSectionProperties($details->id, 'blog_colum') != null && getHomePageSectionProperties($details->id, 'blog_colum') == 'col-12') class="d-none" name="blog_colum" id="blog_colum_1"
                                value="col-12">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            <input type="radio" @checked(getHomePageSectionProperties($details->id, 'blog_colum') != null && getHomePageSectionProperties($details->id, 'blog_colum') == 'col-sm-6') class="d-none" name="blog_colum" id="blog_colum_2" value="col-sm-6">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            <input type="radio" @checked(getHomePageSectionProperties($details->id, 'blog_colum') != null && getHomePageSectionProperties($details->id, 'blog_colum') == 'col-sm-6 col-md-4') class="d-none" name="blog_colum" id="blog_colum_3"
        ...
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <input type="text" name="number_of_blogs" class="theme-input-style" value="{{ getHomePageSectionProperties($details->id, 'number_of_blogs') }}" placeholder="00">
        ...
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <input type="text" name="title" class="theme-input-style" value="{{ getHomePageSectionProperties($details->id, 'title') }}"
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    <input type="text" name="title_color" class="color-input form-control style--two"
                        placeholder="#000000" value="{{ getHomePageSectionProperties($details->id, 'title_color') }}">
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                            value="{{ getHomePageSectionProperties($details->id, 'title_color') }}" oninput="selectColor(event,this.value)">
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    <input type="text" name="description_color" class="color-input form-control style--two"
                        placeholder="#000000" value="{{ getHomePageSectionProperties($details->id, 'description_color') }}">
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                            value="{{ getHomePageSectionProperties($details->id, 'description_color') }}" oninput="selectColor(event,this.value)">
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    <input type="text" name="btn_color" class="color-input form-control style--two"
                        placeholder="#000000" value="{{ getHomePageSectionProperties($details->id, 'btn_color') }}">
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker"
                            id="colorPicker" value="{{ getHomePageSectionProperties($details->id, 'btn_color') }}"
                            oninput="selectColor(event,this.value)">
                    </div>
                </div>
        ...
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    ...
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker"
                            id="colorPicker" value="{{ getHomePageSectionProperties($details->id, 'btn_bg_color') }}"
                            oninput="selectColor(event,this.value)">
                    </div>
                </div>
