        ...
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <select class="theme-input-style" id="blogPostStyle" name="post_style" required
                    onchange="selectPostStyleOption('new_blog')">
                ...
                <div class="input-group addon">
                    ...
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker"
                            id="colorPicker" value="{{ getHomePageSectionProperties($details->id, 'title_color') }}"
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    <input type="text" name="description_color" class="color-input form-control style--two"
                        placeholder="#000000"
                        value="{{ getHomePageSectionProperties($details->id, 'description_color') }}">
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker"
                            id="colorPicker"
                            value="{{ getHomePageSectionProperties($details->id, 'description_color') }}"
