...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="content-info" role="tabpanel" aria-labelledby="content-info-tab">
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <select class="theme-input-style" id="blogPostStyle" name="post_style" required
                    onchange="selectPostStyleOption('category_wise')">
        ...
        <div class="form-row mb-20 category-options">
            <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="input-group">
                            <input type="radio" @checked(getHomePageSectionProperties($details->id, 'blog_colum') != null &&
                                    getHomePageSectionProperties($details->id, 'blog_colum') == 'col-12') class="d-none" name="blog_colum"
                                id="blog_colum_1" value="col-12">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            <input type="radio" @checked(getHomePageSectionProperties($details->id, 'blog_colum') != null &&
                                    getHomePageSectionProperties($details->id, 'blog_colum') == 'col-sm-6') class="d-none" name="blog_colum"
                                id="blog_colum_2" value="col-sm-6">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            <input type="radio" @checked(getHomePageSectionProperties($details->id, 'blog_colum') != null &&
                                    getHomePageSectionProperties($details->id, 'blog_colum') == 'col-sm-6 col-md-4') class="d-none" name="blog_colum"
                                id="blog_colum_3" value="col-sm-6 col-md-4">
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    <input type="text" name="bg_color" class="color-input form-control style--two"
                        placeholder="#0000000" value="{{ getHomePageSectionProperties($details->id, 'bg_color') }}">
                    <div class="input-group-append">
                        <input type="color" class="input-group-text theme-input-style2 color-picker"
